...
[travis-badge]: https://travis-ci.org/filipesilva/angular-avam-ng-layout.svg?branch=master
[travis-badge-url]: https://travis-ci.org/filipesilva/angular-avam-ng-layout
...
1. Create a project folder (you can call it `avam-ng-layout` and rename it later).
...
```
git clone https://github.com/filipesilva/angular-avam-ng-layout.git
cd angular-avam-ng-layout
npm install
npm start
```
...
### Download
[Download the QuickStart Library seed](https://github.com/filipesilva/angular-avam-ng-layout/archive/master.zip)
...
Use your editor to search the project for all instances of `avam-ng-layout` and change it
